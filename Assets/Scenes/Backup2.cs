...
{
    public class Backup2 : VisionTaskApiRunner<PoseLandmarker>
    {
        ...
        void Update()
        {
            ...
            leftShoulder = skeletonAnimator.GetBoneTransform(HumanBodyBones.LeftShoulder);
            leftUpperArm = skeletonAnimator.GetBoneTransform(HumanBodyBones.RightUpperArm);
            rightUpperArm = skeletonAnimator.GetBoneTransform(HumanBodyBones.LeftUpperArm);
        ...
        void UseRotation()
        {
            ...
            hip.Rotate(eulers.x, eulers.y - 90, eulers.z, Space.World);
